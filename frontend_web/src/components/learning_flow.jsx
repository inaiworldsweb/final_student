...
const StepCard = ({
  ...
  return (
    <div
      className={`relative p-8 md:p-12 flex flex-col items-center text-center ${className}`}
    >
      {/* Number Circle */}
...
const LearningFlow = () => {
  return (
    <section className="relative w-full max-w-[1050px] mx-auto px-4 py-24 flex flex-col items-center justify-center">
      <h2 className="text-2xl md:text-3xl font-bold text-white mb-20  text-center">
      ...
      <div className="w-full relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 w-full">
          <StepCard
            ...
            showBottomBorder={true}
          />
          <StepCard number="05" title="Track Progress And Improve Weak Areas" />
        </div>
      </div>
