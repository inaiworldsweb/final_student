  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-[1050px] mx-auto relative">
        ...
        <div
          className="absolute top-[80px] left-[-40px] animate-pulse z-10 hidden md:block"
        ...
        <div
          className="flex flex-col items-center justify-start mb-10"
          style={{ gap: "20px" }}
        >
          ...
          <div
            ...
            style={{ gap: "3px" }}
          >
            <h1 className="text-4xl md:text-4xl lg:text-[60px] font-bold leading-[1.1]  text-white">
              <span className="block">Learn Smarter With</span>
              <span className="block mt-2">
                India's <span className="text-[#4169E1]">First</span> Virtual{" "}
                <span className="text-[#4169E1]">AI</span> Teachers
              </span>
            </h1>
          </div>
          ...
          <p className="text-gray-400 text-sm md:text-base max-w-[900px] mx-auto leading-relaxed opacity-80">
            Ed-INAI gives students access to Virtual AI Teachers trained on
            their syllabus delivering live & recorded classes, instant doubt
            solving, and personalized learning support 24×7.
          </p>
        </div>
