...
function Header() {
  ...
  return (
    <motion.section
      className="relative flex flex-col items-center py-10 md:py-16 justify-start text-center px-4"
      initial="hidden"
      animate="visible"
      ...
      <div className="w-full max-w-[1050px] mx-auto relative">
        ...
        >
          ...
          >
            ...
            syllabus delivering live & recorded classes, instant doubt solving,
