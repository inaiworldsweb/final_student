...
const FeaturePill = ({ text, glowClass, borderHoverClass, dotGlow }) => {
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(80.42deg, rgba(0, 0, 0, 0.2) 25.25%, rgba(83, 84, 108, 0.2) 98.05%)",
    ...
    >
      ...
      <div className="flex items-center relative z-10 w-full">
        {/* Glowing Dot */}
        <span
          className={`w-2 h-2 rounded-full bg-white mr-4 shrink-0 transition-all duration-300 
...
const DashboardPreview = () => {
  return (
    ...
    >
      ...
      <div
        className="absolute top-[30%] right-[-20px] hidden md:block animate-pulse duration-[4000ms] opacity-60"
