...
const IconCard = ({ icon, color, glowColor, title, description }) => {
  ...
  return (
    <motion.div
      ...
      className="rounded-2xl p-8 flex flex-col items-start text-left  transition-all duration-300 ease-out group relative overflow-hidden border border-transparent hover:border-white/10"
      style={{
        background: `
