...
const LoveCard = ({ icon, text, glowClass, iconBgClass, customBoxShadow }) => {
  return (
    ...
    >
      {/* Bottom Glow */}
      <div
        className={`absolute bottom-0 left-0 right-0 h-1/2 bg-gradient-to-t ${glowClass} opacity-20 blur-xl group-hover:opacity-30 transition-opacity`}
      ></div>
      ...
      >
        ...
        >
          ...
          <LoveCard
            icon={
              <img
                src={doubtClearedIcon}
                alt="Doubts Cleared Instantly"
                className="w-full h-full object-contain"
              />
            }
        ...
        >
          ...
          >
            <path
              d="M12 0C12 0 13.5 8.5 22 12C13.5 15.5 12 24 12 24C12 24 10.5 15.5 2 12C10.5 8.5 12 0 12 0Z"
              fill="#9CA3AF"
            />
          </svg>
        </motion.div>
