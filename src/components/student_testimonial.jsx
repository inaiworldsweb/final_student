...
const testimonials = [
  ...
  {
    quote:
      "The personalized learning path helped me improve my grades significantly.",
  ...
  {
    quote:
      "The interactive 3D models helped me visualize Biology concepts easily.",
    author: "NEET Student",
  },
];
  ...
  return (
    ...
    >
            ...
            >
              {getVisibleTestimonials().map((item, idx) => (
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(180deg, rgba(10, 10, 15, 1) 0%, rgba(20, 20, 35, 1) 100%)",
                  }}
                >
      ...
      <div className="flex md:hidden gap-6 mt-6">
        <button
          onClick={prevTestimonial}
          className="w-12 h-12 rounded-full bg-blue-900/20 border border-white/10 flex items-center justify-center text-white"
        >
          <svg
            width="20"
            height="20"
